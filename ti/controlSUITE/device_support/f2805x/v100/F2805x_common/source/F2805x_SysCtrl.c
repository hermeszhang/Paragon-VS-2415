...
//---------------------------------------------------------------------------
// Example: DcsmZ1Unlock:
//---------------------------------------------------------------------------
// This function unlocks the Z1 DCSM. User must replace 0xFFFFFFFF's with current
// password for Zone 1. Returns 1 if unlock is successful.
...
Uint16 DcsmZ1Unlock()
{
	...
	while ((zerofound == 0) && (bitpos > -1))
	{
		...
		{
		    zerofound = 1;
			Z1_ZoneSelBlockPtr = (Uint32 *)((Uint32)(&DcsmOtpZ1) + ((bitpos + 2)*16));			
		}
		else
		{
		    bitpos--;
...
//---------------------------------------------------------------------------
// Example: DcsmZ2Unlock:
//---------------------------------------------------------------------------
// This function unlocks the Z2 DCSM. User must replace 0xFFFFFFFF's with current
// password for Zone 2. Returns 1 if unlock is successful.
...
Uint16 DcsmZ2Unlock()
{
	...
	while ((zerofound == 0) && (bitpos > -1))
	{
		...
		{
		    zerofound = 1;
			Z2_ZoneSelBlockPtr = (Uint32 *)((Uint32)(&DcsmOtpZ2) + ((bitpos + 2)*16));			
		}
		else
		{
		    bitpos--;
