//###########################################################################
//
// FILE:    F2805x_SWPrioritizedIsrLevels.h
//
...
#ifndef F2805x_SW_PRIORITZIED_ISR_H
#define F2805x_SW_PRIORITZIED_ISR_H
...
//-------------------------------------------------------------------------------
// Interrupt Enable Register Allocation For 2805x Devices:
//-------------------------------------------------------------------------------
// Interrupts can be enabled/disabled using the CPU __interrupt enable register
// (IER) and the PIE __interrupt enable registers (PIEIER1 to PIEIER12).
//-------------------------------------------------------------------------------
//-------------------------------------------------------------------------------
// Set "Global" Interrupt Priority Level (IER register):
//-------------------------------------------------------------------------------
// The user must set the appropriate priority level for each of the CPU
// __interrupts. This is termed as the "global" priority. The priority level
// must be a number between 1 (highest) to 16 (lowest). A value of 0 must
// be entered for reserved __interrupts or __interrupts that are not used. This
...
//       __interrupt masks MINT1 to MINT16.
//
//
...
// __interrupts. This is termed as the "group" priority. The priority level
...
//       PIEIER register __interrupt masks:
//                           MG11 to MG18
//                           MG21 to MG28
//                           MG31 to MG38
//                           MG41 to MG48
...
#define	G111PL      1        // CLAINT1 (CLA)
#define	G112PL      2        // CLAINT2 (CLA)
#define	G113PL      4        // CLAINT3 (CLA)
#define	G114PL      3        // CLAINT4 (CLA)
#define	G115PL      5        // CLAINT5 (CLA)
#define	G116PL      1        // CLAINT6 (CLA)
#define	G117PL      7        // CLAINT7 (CLA)
#define	G118PL      1        // CLAINT8 (CLA)
...
#define	G127PL      3        // CLA - LVF
#define	G128PL      2        // CLA - LUF

// There should be no need to modify code below this line
//-------------------------------------------------------------------------------
// Automatically generate IER __interrupt masks MINT1 to MINT16:
//
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG11 to MG18:
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG21 to MG28:
//
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG31 to MG38:
//
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG41 to MG48:
//
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG51 to MG58:
//
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG61 to MG68:
//
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG71 to MG78:
//
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG81 to MG88:
//
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG91 to MG98:
//
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG101 to MG108:
//
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG111 to MG118:
//
...
//-------------------------------------------------------------------------------
// Automatically generate PIEIER1 __interrupt masks MG121 to MG128:
//
