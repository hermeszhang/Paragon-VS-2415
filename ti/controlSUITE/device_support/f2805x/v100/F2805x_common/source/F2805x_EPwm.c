...
// FILE:   F2805x_EPwm.c
//
// TITLE:  F2805x EPwm Initialization & Support Functions.
//
//###########################################################################
...
// Comment out other unwanted lines.
    ...
    // GpioCtrlRegs.GPAPUD.bit.GPIO20 = 1;    // Disable pull-up on GPIO20 (EPWM7A)
	// GpioCtrlRegs.GPAPUD.bit.GPIO21 = 1;    // Disable pull-up on GPIO20 (EPWM7B)
    // GpioCtrlRegs.GPAPUD.bit.GPIO24 = 1;    // Disable pull-up on GPIO24 (EPWM7A)

	GpioCtrlRegs.GPAPUD.bit.GPIO30 = 1;    // Disable pull-up on GPIO30 (EPWM7A)
	GpioCtrlRegs.GPAPUD.bit.GPIO31 = 1;    // Disable pull-up on GPIO31 (EPWM7B)	

	// GpioCtrlRegs.GPBPUD.bit.GPIO40 = 1;    // Disable pull-up on GPIO40 (EPWM7A)
    // GpioCtrlRegs.GPBPUD.bit.GPIO42 = 1;    // Disable pull-up on GPIO42 (EPWM7B)
...
// Comment out other unwanted lines.
    ...
    // GpioCtrlRegs.GPAMUX2.bit.GPIO20 = 2;    // Configure GPIO20 as EPWM7A
	// GpioCtrlRegs.GPAMUX2.bit.GPIO21 = 2;    // Configure GPIO21 as EPWM7B	
	// GpioCtrlRegs.GPAMUX2.bit.GPIO24 = 2;    // Configure GPIO24 as EPWM7A

    GpioCtrlRegs.GPAMUX2.bit.GPIO30 = 3;   // Configure GPIO30 as EPWM7A
    GpioCtrlRegs.GPAMUX2.bit.GPIO31 = 3;   // Configure GPIO31 as EPWM7B	

    //  GpioCtrlRegs.GPBMUX1.bit.GPIO40 = 1;   // Configure GPIO40 as EPWM7A
    //  GpioCtrlRegs.GPBMUX1.bit.GPIO42 = 1;   // Configure GPIO42 as EPWM7B
...
/* Configure TZ pins as inputs */
// This specifies TZ functional pins as inputs.
// Comment out other unwanted lines.
   GpioCtrlRegs.GPADIR.bit.GPIO12 = 0;  // Configure GPIO12 as an input
//   GpioCtrlRegs.GPADIR.bit.GPIO15 = 0;  // Configure GPIO15 as an input
   GpioCtrlRegs.GPADIR.bit.GPIO13 = 0;  // Configure GPIO13 as an input
// GpioCtrlRegs.GPADIR.bit.GPIO16 = 0;  // Configure GPIO16 as an input
// GpioCtrlRegs.GPADIR.bit.GPIO28 = 0;  // Configure GPIO28 as an input
   GpioCtrlRegs.GPADIR.bit.GPIO14 = 0;  // Configure GPIO14 as an input
// GpioCtrlRegs.GPADIR.bit.GPIO17 = 0;  // Configure GPIO17 as an input
// GpioCtrlRegs.GPADIR.bit.GPIO29 = 0;  // Configure GPIO29 as an input
