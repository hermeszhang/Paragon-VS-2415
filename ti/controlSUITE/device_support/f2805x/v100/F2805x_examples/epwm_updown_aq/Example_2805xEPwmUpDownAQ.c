//###########################################################################
//
// FILE:    Example_2805xEPwmUpDownAQ.c
//
...
void InitEPwm1Example()
{
   ...
   epwm1_info.EPwmTimerIntCount = 0;               // Zero the __interrupt counter
...
void InitEPwm2Example()
{
   ...
   epwm2_info.EPwmTimerIntCount = 0;               // Zero the __interrupt counter
...
void InitEPwm3Example(void)
{
  ...
  // Set Compare values
   ...
   epwm3_info.EPwmTimerIntCount = 0;               // Zero the __interrupt counter
...
void update_compare(EPWM_INFO *epwm_info)
{
   ...
   // Every 10'th __interrupt, change the CMPA/CMPB values
