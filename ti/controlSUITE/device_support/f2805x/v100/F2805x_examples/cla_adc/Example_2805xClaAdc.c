...
//
// TITLE:  F2805x CLA Reads ADC Result Registers Example Program.
//
// ASSUMPTIONS:
//
...
//
//   Connect signals to be converted to A2.
//
//    $Boot_Table:
//
...
//
//   When Task2 completes an __interrupt to the CPU clears the ADCINT2 flag.
//
//   Watch Variables:
//
//         VoltageCLA[20]   Last 20 ADCRESULT1 values
