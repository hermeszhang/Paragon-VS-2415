//###########################################################################
//
// FILE:    F2805x_DefaultIsr.h
//
// TITLE:   F2805x Devices Default Interrupt Service Routines Definitions.
//
//###########################################################################
...
#ifndef F2805x_DEFAULT_ISR_H
#define F2805x_DEFAULT_ISR_H
...
// This default vector table is found in the F2805x_PieVect.h
// file.
//
...
__interrupt void  XINT1_ISR(void);     // External __interrupt 1
__interrupt void  XINT2_ISR(void);     // External __interrupt 2
...
__interrupt void INT_NOTUSED_ISR(void);    // for unused __interrupts

#ifdef __cplusplus
}
#endif /* extern "C" */

#endif    // end of F2805x_DEFAULT_ISR_H definition
