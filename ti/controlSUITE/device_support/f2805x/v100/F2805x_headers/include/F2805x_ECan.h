...
// FILE:   F2805x_ECan.h
//
// TITLE:  F2805x Device eCAN Register Definitions.
//
//###########################################################################
...
#ifndef F2805x_ECAN_H
#define F2805x_ECAN_H
...
struct CANGIF0_BITS {                   // bits  description
    ...
    Uint16  WLIF0:1;                    // 8 Warning level __interrupt flag 
    Uint16  EPIF0:1;                    // 9 Error-passive __interrupt flag 
    Uint16  BOIF0:1;                    // 10 Bus-off __interrupt flag 
    Uint16  RMLIF0:1;                   // 11 Received message lost __interrupt flag 
    Uint16  WUIF0:1;                    // 12 Wakeup __interrupt flag 
    Uint16  WDIF0:1;                    // 13 Write denied __interrupt flag 
    Uint16  AAIF0:1;                    // 14 Abort Ack __interrupt flag 
    Uint16  GMIF0:1;                    // 15 Global MBX __interrupt flag 
...
struct CANGIM_BITS{                     // bits  description
    ...
    Uint16  WLIM:1;                     // 8 Warning level __interrupt mask 
    Uint16  EPIM:1;                     // 9 Error-passive __interrupt mask 
    Uint16  BOIM:1;                     // 10 Bus-off __interrupt mask 
    Uint16  RMLIM:1;                    // 11 Received message lost __interrupt mask 
    Uint16  WUIM:1;                     // 12 Wakeup __interrupt mask 
    Uint16  WDIM:1;                     // 13 Write denied __interrupt mask 
    Uint16  AAIM:1;                     // 14 Abort Ack __interrupt mask 
    Uint16  rsvd2:1;                    // 15 reserved 
    Uint16  TCOM:1;                     // 16 TSC overflow __interrupt mask 
    Uint16  MTOM:1;                     // 17 MBX Timeout __interrupt mask 
...
struct CANGIF1_BITS {                   // bits  description
    ...
    Uint16  rsvd1:3;                    // 7:5 reserved 
    Uint16  WLIF1:1;                    // 8 Warning level __interrupt flag 
    Uint16  EPIF1:1;                    // 9 Error-passive __interrupt flag 
    Uint16  BOIF1:1;                    // 10 Bus-off __interrupt flag 
    Uint16  RMLIF1:1;                   // 11 Received message lost __interrupt flag 
    Uint16  WUIF1:1;                    // 12 Wakeup __interrupt flag 
    Uint16  WDIF1:1;                    // 13 Write denied __interrupt flag 
    Uint16  AAIF1:1;                    // 14 Abort Ack __interrupt flag 
    Uint16  GMIF1:1;                    // 15 Global MBX __interrupt flag 
...
#endif                                  // end of F2805x_ECAN.H definition
