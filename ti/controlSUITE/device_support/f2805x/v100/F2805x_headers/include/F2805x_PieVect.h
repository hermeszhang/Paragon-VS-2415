//###########################################################################
//
// FILE:   F2805x_PieVect.h
//
// TITLE:  F2805x Devices PIE Vector Table Definitions.
//
//###########################################################################
...
#ifndef F2805x_PIE_VECT_H
#define F2805x_PIE_VECT_H
...
//
// Create a user type called PINT (pointer to __interrupt):
...
// Non-Peripheral Interrupts:
    ...
    PINT  DATALOG;                      // Datalogging __interrupt 
    PINT  RTOSINT;                      // RTOS __interrupt 
    PINT  EMUINT;                       // Emulation __interrupt 
    PINT  NMI;                          // Non-maskable __interrupt 
...
#endif                                  // end of F2805x_PIE_VECT_H definition
