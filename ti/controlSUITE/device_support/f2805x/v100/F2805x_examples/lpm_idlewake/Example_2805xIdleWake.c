...
//    XINT1 __interrupt upon detection of a falling edge.
//    Initially, pull GPIO0 high externally. To wake device
//    from idle mode by triggering an XINT1 __interrupt,
...
// Enable XINT1 in the PIE: Group 1 __interrupt 4
...
// Write the LPM code value
  ...
  EDIS;
 asm(" IDLE");                            // Device waits in IDLE until XINT1 __interrupts
  for(;;){}
}
