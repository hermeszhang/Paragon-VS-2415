...
//
// TITLE:  F2805x Watchdog __interrupt test program.
//
// ASSUMPTIONS:
//
...
//
//   First the watchdog is connected to the WAKEINT __interrupt of the
...
//   then the WAKEINT __interrupt is not taken.  If the key register
